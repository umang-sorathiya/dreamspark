    ...
    <main>
      ...
      <section className="bg-blue-900 text-white py-16 px-6 text-center">
        ...
        <p className="text-lg max-w-3xl mx-auto text-gray-200">
          India's best coaching institute transforming youth into global human resources since inception.
        </p>
      </section>
      ...
      <section className="bg-gray-50 py-16 px-6">
        <div className="max-w-6xl mx-auto">
          <h2 className="text-3xl font-bold text-center text-blue-900 mb-10">Why Are We Unique?</h2>
          <div className="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-5 gap-6">
            {[
              ...
              <div key={i} className="bg-white rounded-xl p-6 text-center shadow hover:shadow-lg transition border border-gray-100">
